    ...
    public class DeserializeHelper
    {
        public static ExchangePlace DeserializeExchangePlace(IDictionary<string, object> serializedPlace, ILogger logger)
        {
            ExchangePlace exchangePlace = new ExchangePlace
            {
                ...
                FullyEnclosed = GetProperty("FullyEnclosed", serializedPlace) == "True",
                SurfaceHub = GetProperty("SurfaceHub", serializedPlace) == "True",
                WhiteboardCamera = GetProperty("WhiteboardCamera", serializedPlace) == "True",
